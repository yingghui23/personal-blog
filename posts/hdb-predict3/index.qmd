...
Users would just need to key in the relevant features of the HDB they want to forecast, then add how many months of forecasted data they would prefer. This can be shown in the picture:

![Streamlit demo](demo.png)

Here is the link for the streamlit application for users to see the forecasts:

https://hdbpredict-mm7oymwyumwmnabmmaegr7.streamlit.app/ 
